    ...
    <section className="section-shell section-padding">
      <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
        <motion.div
          ...
          className="media-placeholder aspect-[4/3] overflow-hidden rounded-lg lg:order-last"
          aria-hidden
        >
        ...
        >
          ...
          <p className="text-xl leading-relaxed text-balance text-foreground sm:text-2xl">
            {snippet}
          </p>
          <Link
            href="/about"
